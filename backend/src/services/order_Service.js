...
async function findOrderById(orderId) {
  let order = await Order.findById(orderId)
    .populate({ path: "user", model: "users", strictPopulate: false }) // Assuming your user model is named "users"
    .populate({ path: "orderItems", populate: { path: "product" } }) // Change "products" to "product"
