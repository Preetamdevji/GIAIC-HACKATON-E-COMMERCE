...
import ProcductCart from "./ProcductCart";
...
import FilterTuneIcon from '@mui/icons-material/Tune';
...
export default function Product() {
  ...
  // console.log('Product Store => ', product.products.Content);
  // setItem(product.products.content);
  ...
  const handleFilter = (value, sectionId) => {
    ...
    navigate({ search: `?${queryParameter}` });
  };
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="lg:col-span-3 w-full">
                <div className="flex flex-wrap justify-center bg-white py-5">
                  {/* {mens_kurtaData.map((item) => (
                    <ProcductCart product={item} />
                  ))} */}
                  {/* <p>{product.products?.Content}</p> */}
