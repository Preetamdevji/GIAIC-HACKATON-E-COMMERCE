...
export const FIND_PRODUCTS_REQUEST = "FIND_PRODUCTS_CATEGORY_REQUEST";
export const FIND_PRODUCTS_SUCCESS = "FIND_PRODUCTS_CATEGORY_SUCCESS";
export const FIND_PRODUCTS_FAILURE = "FIND_PRODUCTS_CATEGORY_FAILURE";
